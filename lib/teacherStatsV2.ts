...
// Cacheado (30 min, invalidable con el botón de sincronizar): esta lectura de class_sessions_v2
// se repetía sin caché en cada carga de Analítica.
export const getTeacherStatsV2 = unstable_cache(
  async (from: string, to: string): Promise<TeacherStatsV2> => {
