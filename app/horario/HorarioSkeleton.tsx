...
export default function HorarioSkeleton() {
  ...
  return (
    <div>
      ...
      <div className="sticky top-0 z-20 bg-app-bg/95 backdrop-blur-sm border-b border-navy/[0.06]">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 h-[45px] flex items-center justify-between gap-3">
          ...
          <div className="hidden sm:flex items-center gap-2 animate-pulse">
            <div className="w-7 h-7 flex items-center justify-center rounded-md border border-navy/[0.12] bg-white text-navy/20">
              {chevLeft}
            </div>
      ...
      {/* Content */}
      <div className="relative max-w-[1600px] mx-auto px-4 sm:px-6 pt-8 pb-16">
        ...
        <div className="hidden sm:grid grid-cols-4 gap-3 mb-5">
          {[0, 1, 2, 3].map((i) => (
            <div key={i} className="bg-white border border-navy/[0.07] rounded-2xl shadow-card px-5 py-4">
        ...
        {/* Stat card — mobile */}
        <div className="sm:hidden bg-white border border-navy/[0.07] rounded-2xl shadow-card mb-5 overflow-hidden">
        ...
        <div className="hidden sm:flex items-center gap-3 mb-6">
          <div className="h-9 w-40 bg-white border border-navy/[0.1] rounded-lg" />
          <div className="h-9 w-48 bg-white border border-navy/[0.1] rounded-lg" />
          <div className="h-9 w-64 bg-white border border-navy/[0.12] rounded-lg" />
        </div>

        {/* Class list rows */}
        <div className="space-y-3">
          {[0, 1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="bg-white border border-navy/[0.07] rounded-2xl shadow-card px-5 py-4 flex items-center gap-4">
