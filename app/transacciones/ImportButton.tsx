    ...
    <>
      <div ref={ref} className={`relative ${className}`}>
        <button
          ...
          className={
            compact
              ? "flex items-center justify-center gap-1.5 px-3 h-9 bg-white text-navy text-xs font-medium border border-navy/15 rounded-xl hover:bg-navy/[0.02] transition-colors w-full"
