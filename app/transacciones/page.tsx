  ...
  return (
    <div>
      ...
      <div className="sticky top-0 z-20 bg-app-bg/95 backdrop-blur-sm border-b border-navy/[0.06]">
        <div className="max-w-6xl mx-auto px-4 sm:px-3 h-[45px] flex items-center justify-between gap-3">
      ...
      {/* ── Content ── */}
      <div className="px-2 sm:px-3 pt-5 sm:pt-8 pb-16 max-w-6xl mx-auto">
