...
const NAME_TO_KEY: Record<string, string> = {
  ...
  "IVA": "percent", "IRPF": "percent", "IS": "percent",
  "Software": "monitor", "Suministros": "zap", "Electricidad": "zap", "Luz": "zap", "Agua": "droplet",
...
export function CatIcon({ iconKey, name, color, size = 12 }: { iconKey: string; name: string; color: string; size?: number }) {
