...
export default function FinanzasSkeleton() {
  return (
    <div className="relative">
      ...
      {/* Evolución de inscritos chart */}
      <div className="mb-8">
        <ChartSkeleton />
      </div>

      {/* Resumen financiero */}
      <div className="bg-white border border-navy/[0.07] rounded-2xl shadow-card p-4 sm:p-6 mb-8 animate-pulse">
        <div className="h-2.5 w-32 bg-navy/10 rounded mb-1.5" />
        <div className="h-2 w-48 bg-navy/[0.07] rounded mb-5" />
        <div className="h-[100px] bg-navy/[0.05] rounded-xl" />
      </div>

      {/* Secciones Q1-Q3 con KPIs + gráficos */}
      <div className="space-y-14">
        {[0, 1, 2].map((section) => (
          <div key={section} className="space-y-4">
            <div className="h-3 w-56 bg-navy/10 rounded mb-2 animate-pulse" />
