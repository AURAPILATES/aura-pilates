      ...
      <div ref={sentinelRef} className="mb-8">
        ...
        <div className="sm:hidden bg-white border border-navy/10 rounded-xl shadow-card overflow-hidden">
          <div className="grid grid-cols-2 divide-x divide-navy/[0.07]">
            ...
            <div className="p-5 border-b border-navy/[0.07]">
              <p className="text-[10px] font-semibold text-navy/50 uppercase tracking-wider mb-2">Saldo</p>
              <p className="text-xl font-semibold text-navy tabular-nums leading-tight">
                {currentBalance !== null ? fmt(currentBalance) : "—"}
              </p>
              {balanceDate && (
                <p className="text-[10px] text-navy/55 mt-1">{balanceDate.split("-").reverse().join("/")}</p>
              )}
            </div>
            ...
            {/* Resultado */}
            <div className="p-5">
              <p className="text-[10px] font-semibold text-navy/50 uppercase tracking-wider mb-0.5">Resultado</p>
              <p className="text-[10px] text-navy/55 mb-2">{curMonthLabel}</p>
        ...
        <div className="hidden sm:grid sm:grid-cols-4 gap-4">
          ...
          <div className="bg-white border border-navy/[0.07] rounded-2xl shadow-card p-5">
            ...
            ) : <p className="text-2xl font-semibold text-navy/50">Sin ventas</p>}
          </div>
