  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <input
        ...
        className="w-full h-[37.5px] pl-9 pr-9 text-[13.5px] border border-border rounded-[10px] bg-card shadow-card text-navy placeholder:text-faint outline-none focus:ring-2 focus:ring-navy/10 focus:border-navy/30 transition"
      />
      {value ? (
        <button
          type="button"
