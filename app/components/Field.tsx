...
export default function Field({ label, children, align = "center", className = "" }: {
  ...
  return (
    <fieldset
      className={`group flex ${align === "start" ? "items-start" : "items-center"} gap-2 border border-navy/[0.12] rounded-[8px] pt-2 px-3 pb-3 transition-colors focus-within:border-primary/40 ${className}`}
    >
