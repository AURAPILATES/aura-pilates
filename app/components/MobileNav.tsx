...
export default function MobileNav() {
  ...
  const drawer = (
    <>
      {/* Overlay */}
      <div
        className={`sm:hidden fixed inset-0 z-40 bg-navy/30 transition-opacity ${
      ...
      {/* Drawer */}
      <div
        className={`sm:hidden fixed top-0 left-0 h-full w-[260px] bg-white z-50 shadow-xl flex flex-col transition-transform duration-200 ${
      ...
      >
        <div className="px-5 py-5 flex items-center justify-between">
          ...
          <button
            ...
            className="w-8 h-8 flex items-center justify-center rounded-lg text-navy/50 hover:bg-navy/[0.04]"
          >
